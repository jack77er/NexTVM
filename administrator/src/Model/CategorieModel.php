...
class CategorieModel extends AdminModel
{
	 ...
	 * @since  4.0.0
	 */
	public $typeAlias = 'com_tvm.categories';
	 ...
	 * @since   4.0.0
	 */
	public function getTable($type = 'Categories', $prefix = 'Administrator', $config = array())
	{
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_tvm.edit.tvm.data', array());
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = $this->getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__tvm_categories');
				$max             = $db->loadResult();
