...
namespace Seebaren\Component\Tvm\Administrator\View\Templates;
// No direct access
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_('COM_TVM_TITLE_TEMPLATES'), "generic");

		$toolbar = Toolbar::getInstance('toolbar');

		// Check if the form exists before showing the add/edit buttons
		$formPath = JPATH_COMPONENT_ADMINISTRATOR . '/src/View/Templates';
		...
		if ($canDo->get('core.edit.state')  || count($this->transitions))
		{
			...
			elseif (isset($this->items[0]))
			{
				...
				$toolbar->delete('templates.delete')
		...
		// Set sidebar action
		Sidebar::setAction('index.php?option=com_tvm&view=templates');
	}
