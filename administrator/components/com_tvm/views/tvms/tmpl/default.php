...
?>
<form action="index.php?option=com_tvm&view=tvms" method="post" id="adminForm" name="adminForm">
	...
	<table class="table table-striped table-hover">
		...
		<tr>
			...
			<th >
				<?php echo JText::_('COM_TVM_ENTRY_CATEGORY_NAME') ;?>
			</th>
			<th >
			...
			<th>
				<?php echo JText::_('COM_TVM_EVENT_PERIODIC'); ?>
			</th>			
			<th>
				<?php echo JText::_('COM_TVM_EVENT_COMMENT'); ?>
			</th>
			<th>
				<?php echo JText::_('COM_TVM_EVENT_CLOSED'); ?>
			</th>
			<th >
					...
					<tr>
						...
						<td>
							<?php 
								...
								$query->where($db->quoteName('id').'='.$row->category);
								$db->setQuery($query);
								$cat = $db->loadResult();
								echo $cat; 
							?>
						...
						<td align="center">
							<?php 
								echo TvmHelper::getPeriodicName($row->periodic);
							?>
						</td>
						<td align="center">
